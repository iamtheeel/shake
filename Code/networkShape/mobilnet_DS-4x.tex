...
\tikzset{ every node/.append style={ font=\fontsize{30}{36}\selectfont } }
...
\node[canvas is zy plane at x=0] (temp) at (-1,-5,0) {\includegraphics[width=42.66 cm,height=5.18 cm]{cwt.png}};
...
% Big caption (lower)
\node[font=\bfseries\fontsize{30}{34}\selectfont]
  at ([xshift=-235, yshift=-275]input-south) {Input};
\node[font=\fontsize{24}{28}\selectfont, rotate=45 ]
  at ([xshift=-170,yshift=-270]input-east) {2133};
%%
...
\node[font=\bfseries\fontsize{30}{34}\selectfont]
  at ([xshift=-130, yshift=-155]inpConv-south) {Conv};
\node[font=\fontsize{24}{28}\selectfont, rotate=45 ]
  at ([xshift=-70,yshift=-125]inpConv-east) {1067};

% Inverted Res 1
\pic[shift={(2,0,0)}] at (inpConv-east) {RightBandedBox={name=invRes1,caption={},%
        xlabel={{"",}},zlabel={},
        fill=\InvResColor,bandfill=\ConvReluColor,%
        height=12.8,width=1.6,depth=106.7}};
\node[font=\fontsize{30}{34}\selectfont]
  at ([xshift=-90, yshift=-130]invRes1-south) {16x128};
\node[font=\bfseries\fontsize{30}{34}\selectfont]
  at ([xshift=-90, yshift=-155]invRes1-south) {InvRes};
\node[font=\fontsize{24}{28}\selectfont, rotate=45 ]
  at ([xshift=-70,yshift=-125]invRes1-east) {1067};
% Inverted Res 2, 3
\pic[shift={(2,0,0)}] at (invRes1-east) {RightBandedBox={name=invRes2,caption={},%
        xlabel={{"24x64",}},zlabel={},fill=\InvResColor,bandfill=\ConvReluColor,%
        height=6.4,width={2.4,2.4},depth=53.4}};
\node[font=\bfseries\fontsize{30}{34}\selectfont]
  at ([xshift=-50, yshift=-95]invRes2-south) {InvRes};
\node[font=\fontsize{24}{28}\selectfont, rotate=45 ]
  at ([xshift=-20,yshift=-55]invRes2-east) {534};
% Inverted Res 4, 5, 6
\pic[shift={(1.8,0,0)}] at (invRes2-east) {RightBandedBox={name=invRes4,caption={},%
        xlabel={{, "32x32", }},zlabel={},
        fill=\InvResColor,bandfill=\ConvReluColor,%
        height=3.2,width={3.2, 3.2, 3.2},depth=26.7}};
\node[font=\bfseries\fontsize{30}{34}\selectfont]
  at ([xshift=-20, yshift=-65]invRes4-south) {InvRes};
\node[font=\fontsize{24}{28}\selectfont, rotate=45 ]
  at ([xshift=-5,yshift=-35]invRes4-east) {267};
% Inverted Res 7, 8, 9, 10
\pic[shift={(1.5,0,0)}] at (invRes4-east) {RightBandedBox={name=invRes7,caption={},
        xlabel={{,"64x16", ,}},
        zlabel={\scalebox{2.8}{134}},
        fill=\InvResColor,bandfill=\ConvReluColor,%
        height=1.6,width={6.4,6.4,6.4,6.4},depth=13.4}};
\node[font=\bfseries\fontsize{30}{34}\selectfont]
  at ([xshift=-20, yshift=-50]invRes7-south) {InvRes};
% Inverted Res 11, 12, 13
\pic[shift={(1.5,0,0)}] at (invRes7-east) {RightBandedBox={name=invRes11,caption={},%
        xlabel={{,"96x16", }},
        zlabel={\scalebox{2.8}{134}},
        fill=\InvResColor,bandfill=\ConvReluColor,%
        height=1.6,width={9.6,9.6,9.6},depth=13.4}};
\node[font=\bfseries\fontsize{30}{34}\selectfont]
  at ([xshift=-20, yshift=-50]invRes11-south) {InvRes};
% Inverted Res 14, 15, 16
\pic[shift={(1.5,0,0)}] at (invRes11-east) {RightBandedBox={name=invRes14,caption={},%
        xlabel={{,"160x8", ,}},
        zlabel={\scalebox{2.8}{67}},
        fill=\InvResColor,bandfill=\ConvReluColor,%
        height=0.8,width={16,16,16},depth=6.7}};
\node[font=\bfseries\fontsize{30}{34}\selectfont]
  at ([xshift=-20, yshift=-45]invRes14-south) {InvRes};
% Inverted Res 17
\pic[shift={(1.5,0,0)}] at (invRes14-east) {RightBandedBox={name=invRes17,caption={},%
        xlabel={{"320x8",}},
        zlabel={\scalebox{2.8}{67}},
        fill=\InvResColor,bandfill=\ConvReluColor,%
        height=0.8,width={32},depth=6.7}};
\node[font=\bfseries\fontsize{30}{34}\selectfont]
  at ([xshift=-20, yshift=-45]invRes17-south) {InvRes};

% Conv2d, NormActivation
\pic[shift={(1.5,0,0)}] at (invRes17-east) {RightBandedBox={name=conv18,caption={},%
        xlabel={{"1280x8",}},
        zlabel={},
        fill=\ConvColor,bandfill=\ConvReluColor,%
        height=0.8,width={128},depth=6.7}};
\node[font=\bfseries\fontsize{30}{34}\selectfont]
  at ([xshift=-20, yshift=-45]conv18-south) {Conv-GroupNorm-ReLU};
\node[font=\fontsize{24}{28}\selectfont, rotate=45 ]
  at ([xshift=-0,yshift=-25]conv18-east) {67};
